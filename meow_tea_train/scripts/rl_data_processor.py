...
from agentic_utils.data_mapping.rl_data_mapping import textworld_make_map_fn
...
def main():
    ...
    parser.add_argument("--task_id_range", type=int, nargs=2, required=True, metavar=("START", "END"), help="Game ID range (start end)")
    ...
    # Create dataset ID
    dataset_id = f"{args.task_prefix}_{args.task_id_range[0]}-{args.task_id_range[1]}"
